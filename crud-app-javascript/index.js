...
const updateNameInput = document.getElementById('update-input-name');
const updateEmailInput = document.getElementById('update-input-email');
...
function renderTable() {
    ...
    for (let i = 0; i < users.length; i++) {
        ...
        editBtn.className = 'input__edit-btn';
        const deleteBtn = document.createElement('button');
        deleteBtn.className = 'input__delete-btn';
...
function showUpdateForm(userId) {
    ...
    if (user) {
        ...
        document.querySelector('.update__container').style.display = "block";
    }
}
...
function hideUpdateForm() {
    ...
    document.querySelector('.update__container').style.display = "none";
}
